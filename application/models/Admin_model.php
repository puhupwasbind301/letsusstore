...
class Admin_model extends CI_Model{
 ...
 /*-------------------------------------------------------------------------
	| Method : count Dashboard Puhupwas Starts
	|-------------------------------------------------------------------------*/
	public function countPage(array $page_name = []) {
	...
	public function insertSupplierProduct(){
			...
			$data = array(
				'sp_name' => $this->input->post('product_name'),
				'sp_type' => $this->input->post('product_type'),
				'sp_price' => $this->input->post('product_price'),
				'sp_desc' => $this->input->post('desc')
			);
			...
			$q = $this->db->get('supplier_products');

			if($q->num_rows() === 1){
				$this->db->where('sp_id', $id);
				$this->db->update('supplier_products',$data);
	...
	public function insertPage($page_name = ""){
			...
			$data = array(
				$page_name[0].'_title' 			=> $this->input->post('title'),
				$page_name[0].'_desc'  			=> $this->input->post('desc'),
				$page_name[0].'_meta_title'  	=> $this->input->post('meta_title'),
				$page_name[0].'_meta_keyword'  	=> $this->input->post('meta_keyword'),
				$page_name[0].'_meta_description_desc'  	=> $this->input->post('meta_desc')
			);

			// if(empty($id)){
			// $data[$page_name[0].'_id']	= $id;
			// }

			$this->db->where($page_name[0].'_id', $id);
			$q = $this->db->get($page_name);

			if($q->num_rows() === 1){
				$this->db->where($page_name[0].'_id', $id);
				$this->db->update($page_name,$data);
	...
	public function fetch_data($limit, $start)
	 {
	  $this->db->select("*");
	  $this->db->from("user_contact_details");
	  $this->db->order_by("ucd_id", "DESC");
	...
	/*-------------------------------------------------------------------------
	| Method : Update Table By by id
	|-------------------------------------------------------------------------*/
	public function updateTable($table, array $updated_id = [], array $update_data = []){
		// return $updated_id;
		$this->db->where($updated_id);
    ...
    /*-------------------------------------------------------------------------
	| Method : Insert Request Invoice
	|-------------------------------------------------------------------------*/
	public function insertRequestInvoice(){
			
			if($this->input->post('riid') != ''){
				$id = $this->input->post('riid');
			}
			else{
				$id = '';
			}
			...
			$data = array(
				'ri_user_id' => $this->input->post('user_id'),
				'ri_no' => $this->input->post('req_no'),
				'ri_name' => $this->input->post('req_name'),
				'ri_quantity' => $this->input->post('quantity'),
				'ri_price' => $this->input->post('price'),
				'ri_total' => $this->input->post('total')
			);
			...
			$q = $this->db->get('request_invoice');

			if($q->num_rows() === 1){
				$this->db->where('ri_id', $id);
				$this->db->update('request_invoice',$data);
				...
				$this->db->insert('request_invoice',$data);
		...
		public function insertCovidPrecautions(){
			...
			public function insertprivateRooms(){
					...
					$data = array(
						...
						'pr_meta_title' => $this->input->post('meta_title'),
						'pr_meta_keyword' => $this->input->post('meta_keyword'),
						'pr_meta_description_desc' => $this->input->post('meta_desc'),
					);
				...
				public function insertboxStorage(){
						...
						$data = array(
							...
							'bs_meta_title' => $this->input->post('meta_title'),
							'bs_meta_keyword' => $this->input->post('meta_keyword'),
							'bs_meta_description_desc' => $this->input->post('meta_desc'),
						);
					...
					public function insertutilityLocker(){
							...
							$data = array(
								...
								'ul_meta_title' => $this->input->post('meta_title'),
								'ul_meta_keyword' => $this->input->post('meta_keyword'),
								'ul_meta_description_desc' => $this->input->post('meta_desc'),
							);
	...
	public function insertbikeStorage(){
			...
			$data = array(
				...
				'bks_meta_title' => $this->input->post('meta_title'),
				'bks_meta_keyword' => $this->input->post('meta_keyword'),
				'bks_meta_description_desc' => $this->input->post('meta_desc'),
			);
	...
	/*-------------------------------------------------------------------------
			...
			public function addMetaData(){
					...
					$data = array(
						...
						'page_name'  	=> $this->input->post('image_page-meta')
					);
			...
			public function insertHome(){
					...
					$data = array(
						...
						'home_meta_title' => $this->input->post('meta_title'),
						'home_meta_keyword' => $this->input->post('meta_keyword'),
						'home_meta_description_desc' => $this->input->post('meta_desc'),
