<!DOCTYPE html>
<html>
<?php $title = "Corpoate Responsibility Initiative View";
  $nav_page = 4;
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Corpoate Responsibility Initiative View</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?= base_url()?>admin">Home</a></li>
              <li class="breadcrumb-item active"><a href="<?= base_url()?>admin/cri">CRI view</a></li>
              <li class="breadcrumb-item active"><a href="<?= base_url('admin/cri-view')?>">View</a></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <div class="content">
              ...
              <table id="tbl_id" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?= $val->cri_title ?></td>
                    <td><center>
                       <?php if(!empty($val->cri_image)): ?>
                      <img src="<?= base_url().$val->cri_image ?>" width=150 height=150>
                      <?php else: ?>
                    ...
                    <td><a href="#" data-toggle="modal" data-target="#modalview-lg<?= $val->cri_id?>"><i class="fa fa-eye text-info" title="View"></i></a>&emsp;|&emsp;<a href="#" data-toggle="modal" data-target="#modaledit-lg<?= $val->cri_id?>"><i class="fa fa-edit text-success" title="Edit"></i></a>&emsp;|&emsp;<a href="#" data-toggle="modal" data-target="#modal-sm"><i class="fa fa-trash text-danger" title="Delete"></i></a></td>

                  </tr>

                  <!-- Edit Staff -->
          <div class="modal fade" id="modaledit-lg<?= $val->cri_id?>">
        <div class="modal-dialog modaledit-lg">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <!-- form start -->
              <form action="" class="cri_edit" method="post">
                <div class="card-body">
                  <input type="hidden" name="criid" value="<?= $val->cri_id ?>">
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                    <label for="sname">Title</label>
                    <input type="text" class="form-control" name="title" placeholder="Name" required="" value="<?= $val->cri_title ?>">
                            ...
                            <div class="col-md-12">
                              <div class="form-group">
                                ...
                                <div class="custom-file mb-3">
                                    ...
                                    <input type="file" class="custom-file-input" id="customFile" name="filename" value="<?= $val->cri_image ?>">
                                    <?php $v =explode('/',$val->cri_image); ?>
                  ...
                  <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <textarea class="form-control" name="desc"  rows="10"><?= $val->cri_desc ?></textarea>
                      </div>
                   </div>    
                   </div>    
      ...
      <!-- View Staff -->
          <div class="modal fade" id="modalview-lg<?= $val->cri_id?>">
      ...
      <div class="modal fade" id="modal-sm">
        <div class="modal-dialog modal-sm">
          <div class="modal-content">
            ...
            <form action="<?php echo base_url();?>admin/delete-cri" method="post"> 
            <div class="modal-body">
              <input type="hidden" name="criid" value="<?= $val->cri_id?>">
...
let data = new FormData($(this).get(0));
    ...
    ajax(url+"admin/update-cri", data).then(function(result) {
      if(result.result){
