<!DOCTYPE html>
<html>
<?php $title = "Update Storage Calculator Category";
  $nav_page = 6;
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Update Storage Calculator Category</h1>
          </div>
          <div class="col-sm-6">
    ...
    <div class="content">
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <table id="tbl_id" class="table table-bordered table-striped">
                ...
                <tr>
                  <th>#</th>
                  <th>Storage Calculator Category</th>
                  <th>Manage</th>
                </tr>
                </thead>
                <tbody>
                  <?php foreach($storage_calculator_categories as $key => $val): ?>
                  <tr>
                    <td><?= ++$key?></td>
                    <td><?= $val->scc_name ?></td>
                    
                    <td><a href="#" data-toggle="modal" data-target="#modaledit-lg<?= $val->scc_id?>"><i class="fa fa-edit text-success" title="Edit"></i></a>&emsp;|&emsp;<a href="#" data-toggle="modal" data-target="#modal-sm<?= $val->scc_id?>"><i class="fa fa-trash text-danger" title="Delete"></i></a></td>

                  </tr>

                  <!-- Edit Staff -->
                  
          <div class="modal fade" id="modaledit-lg<?= $val->scc_id?>">
        <div class="modal-dialog modaledit-lg">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <!-- form start -->
              <form action="" class="storage_calculator_category_edit" method="post">
                <div class="card-body">
                  <input type="hidden" name="sccid" value="<?= $val->scc_id ?>">
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
	                    <label for="sname">Storage Calculator Category Name</label>
	                    <input type="text" class="form-control" name="storage_cat_name" placeholder="Storage Cat Name" required="" value="<?= $val->scc_name ?>">
                  </div>
                    </div>
      ...
      <!-- View Staff -->
          <div class="modal fade" id="modalview-lg<?= $val->scc_id?>">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="row p-2">
                ...
                <div class="col-md-9">
                    <img src="<?= base_url().$val->scc_image ?>" width=150 height=150 >
                </div>
              </div>
      ...
      <!-- Delete Staff -->
      <div class="modal fade" id="modal-sm<?= $val->scc_id?>">
        <div class="modal-dialog modal-sm">
          <div class="modal-content">
            ...
            <form action="<?php echo base_url();?>admin/delete-storage-calculator_category" method="post"> 
            <div class="modal-body">
              <input type="hidden" name="sccid" value="<?= $val->scc_id?>">
              <!-- <input type="hidden" name="sccid" value="<?= $val->scc_id ?>"> -->
...
<script type="text/javascript">
  $(function() {
    ...
    $('.storage_calculator_category_edit').on('submit' , function (e) {
    e.preventDefault();
...
let data = new FormData($(this).get(0));
    ...
    ajax(url+"admin/update-storage-calculator-category", data).then(function(result) {
      if(result.status){
