      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="card">
            ...
            <div class="card-body">
                  <!-- form start -->
                  <form  id="company_profile" method="post">
                    <div class="card-body">
                ...
                <div class="row">
                 ...
                 <div class="col-md-12">
                   <div class="form-group">
                     <label for="name">Image</label>
                     <div class="custom-file mb-3">
                         <input type="hidden" class="custom-file-input" id="image_page" name="image_page" value="company-profile">
                         <input type="file" class="custom-file-input" id="customFile" name="filename">
                         <label class="custom-file-label" for="customFile" style="overflow:hidden;">Choose Image</label>
                     </div>
                   </div>
...
let url = $('meta[name=url]').attr("content");
let data = new FormData($(this).get(0))
    ajax(url+"admin/insert-company-profile", data).then(function(result) {
