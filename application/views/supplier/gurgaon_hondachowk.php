      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="card">
            ...
            <div class="card-body">
                  <!-- form start -->
                  <form  id="gurgaon_hondachowk" method="post">
                    <div class="card-body">
                      ...
                      <div class="row">
                         <div class="col-md-12">
                          ...
                          <select name="gurgaon_hondachowk_section" id="gurgaon_hondachowk_section" class="form-control" required="required">
                              <option value="" style="display: none;"></option>
                              <option value="1" selected>Gurgaon Hondachowk Section</option>
                              <option value="2">Benefit of Renting Section</option>
...
<script type="text/javascript">
  $(function() {
    $('#gurgaon_hondachowk').on('submit' , function (e) {
    e.preventDefault();
...
let data = new FormData($(this).get(0))
    ajax(url+"admin/insert-gurgaon-hondachowk", data).then(function(result) {
