<!DOCTYPE html>
<html>
<?php $title = "Pune Ranjangaon View";
  $nav_page = 26;
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Pune Ranjangaon View</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?= base_url()?>admin">Home</a></li>
              <li class="breadcrumb-item active"><a href="<?= base_url()?>admin/pune-ranjangaon">Pune Ranjangaon</a></li>
              <li class="breadcrumb-item active"><a href="<?= base_url('admin/pune-ranjangaon-view')?>">View</a></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <div class="content">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><center>
                      ...
                      <?php if(!empty($val->prg_image)): ?>
                      <img src="<?= base_url().$val->prg_image ?>" width=150 height=150 alt="If image is selected only that will be shown on website.">
                     <?php else: ?>
                       <img src="https://via.placeholder.com/150" alt="works-image" style="height:150px;width:150px;">
                     <?php endif; ?>
                    </center></td>
                    <td class="text-justify"><?= $val->prg_desc ?></td>
                    ...
                    <td><a href="#" data-toggle="modal" data-target="#modalview-lg<?= $val->prg_id?>"><i class="fa fa-eye text-info" title="View"></i></a>&emsp;|&emsp;<a href="#" data-toggle="modal" data-target="#modaledit-lg<?= $val->prg_id?>"><i class="fa fa-edit text-success" title="Edit"></i></a>&emsp;|&emsp;<a href="#" data-toggle="modal" data-target="#modal-sm<?= $val->prg_id?>"><i class="fa fa-trash text-danger" title="Delete"></i></a></td>

                  </tr>

                  <!-- Edit Staff -->
          <div class="modal fade" id="modaledit-lg<?= $val->prg_id?>">
        <div class="modal-dialog modaledit-lg">
          <div class="modal-content">
            <div class="modal-header">Edit Pune Ranjangaon</h4>
              <div id="msg"></div>
            ...
            <div class="modal-body">
              <!-- form start -->
              <form action="" class="pune_ranjangaon_edit" method="post">
                <div class="card-body">
                  <input type="hidden" name="prgid" value="<?= $val->prg_id ?>">
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                    <label for="sname">title</label>
                    <input type="text" class="form-control" name="title" placeholder="Name" required="" value="<?= $val->prg_title ?>">
                            ...
                            <div class="col-md-12">
                              <div class="form-group">
                                ...
                                <div class="custom-file mb-3">
                                    ...
                                    <input type="file" class="custom-file-input" id="customFile" name="filename" value="<?= $val->prg_image ?>">
                                    <?php $v =explode('/',$val->prg_image); ?>
                  ...
                  <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <textarea class="form-control" name="desc"  rows="10"><?= $val->prg_desc ?></textarea>
                      </div>
                   </div>    
                   </div>    
      ...
      <!-- View Staff -->
          <div class="modal fade" id="modalview-lg<?= $val->prg_id?>">
        <div class="modal-dialog modalview-lg">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Pune Ranjangaon Detail</h4>
              <div id="msg"></div>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            ...
            <div class="modal-body">
              ...
              <div class="row p-2">
               ...
               <div class="row p-2">
                <div class="col-md-3">
                  <b>Pune Ranjangaon Image</b>
                </div>
                <div class="col-md-9">
                  <p>
                     <img src="<?= base_url().$val->prg_image ?>" width=150 height=150>
                  </p>
                </div>
              </div>
      ...
      <!-- Delete Staff -->
      <div class="modal fade" id="modal-sm<?= $val->prg_id?>">
        <div class="modal-dialog modal-sm">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Delete Pune Ranjangaon</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <form action="<?php echo base_url();?>admin/delete-pune-ranjangaon" method="post"> 
            <div class="modal-body">
              <input type="hidden" name="prgid" value="<?= $val->prg_id?>">
      ...
      <!-- /.modal -->
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Add Pune Ranjangaon</h4>
              <div id="msg"></div>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
...
<script type="text/javascript">
  $(function() {
    ...
    $('.pune_ranjangaon_edit').on('submit' , function (e) {
    e.preventDefault();
...
let data = new FormData($(this).get(0));
    ...
    ajax(url+"admin/update-pune-ranjangaon", data).then(function(result) {
      if(result.result){
