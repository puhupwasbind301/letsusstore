    ...
    <div id="maps">
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15390.148376386041!2d74.00347580592583!3d15.347371618469849!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bbfba106336b741%3A0xeaf887ff62f34092!2sGoa!5e0!3m2!1sen!2sin!4v1626436675209!5m2!1sen!2sin" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
    </div>
    <div class="container container1 container2">
           ...
           <p style="text-align: justify;"><?= nl2br($value->g_desc) ?></p>
           <?php if(!empty($value->g_image)): ?>
               <img class="mt-2 mb-3 img1" src="<?= base_url() ?><?= $value->g_image ?>" alt="">
           <?php endif; ?>
           <?php endforeach ?>
    </div>
   <!--  <div class="container container1">
        <div class="row">
            <div class="col-lg-6">
                <h2 class="ds-h2-sub">
                    Lease Let Us Store in Goa
                </h2>
                <p>With our range of amenities and professional help from dedicated staff, leasing a Let Us Store unit
                    around Goa has never been easier. Individuals and businesses on the lookout for a
                    suitable
                    Let Us Store unit around Goa can head to one of Let Us Store’s warehouses in Gurugram
                    and Noida.</p>
