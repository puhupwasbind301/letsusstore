 ...
 <div class="page-title-area style-four"
  ...
  >
    <div class="container">
      <div class="page-title-content text-start">
        <h2 class="ds-h2">Primary Service</h2>
       <!--  <ul>
          <li><a href="<?= base_url() ?>">Home</a></li>
          <li>Primary Movement</li>
        </ul> -->
      </div>
    </div>
  </div>
  ...
  <!-- <div class="marketing-about-area ptb-100">
    <div class="container container1">
      <h2 class="ds-h2 text-center">Primary Service</h2>
      <div class="row">
        <div class="col-lg-6">
          <div class="marketing-about-image">
            <img src="<?= base_url().'uploads/banner_image/'.'1.jpg' ?>" alt="image" class="ceo-img">
          </div>
        </div>
        <div class="col-lg-6 row1">
          
          <p>Primary Service : Our primary services consists of  <br>
• Interstate transportation <br>
• Port to plant movement  <br>
• Port & terminal to interstate warehouses  <br>
