<!DOCTYPE html>
<html>
<?php $title = "Terms and Conditions View";
  $nav_page = 37;
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href="<?= base_url()?>admin/terms-and-conditions">Terms and Conditions</a></li>
              <li class="breadcrumb-item active"><a href="<?= base_url('admin/terms-and-conditions-view')?>">View</a></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <div class="content">
              ...
              <table id="tbl_id" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?= $val->tac_title ?></td>
                    <td><center>
                        <?php if(!empty($val->tac_image)): ?>
                      <img src="<?= base_url().$val->tac_image ?>" width=150 height=150 >
                     <?php else: ?>
                       <img src="https://via.placeholder.com/150" alt="works-image" style="height:150px;width:150px;">
                     <?php endif; ?>
                    </center></td>
                    <td class="text-justify"><?= $val->tac_desc ?></td>
                    ...
                    <td><a href="#" data-toggle="modal" data-target="#modalview-lg<?= $val->tac_id?>"><i class="fa fa-eye text-info" title="View"></i></a>&emsp;|&emsp;<a href="#" data-toggle="modal" data-target="#modaledit-lg<?= $val->tac_id?>"><i class="fa fa-edit text-success" title="Edit"></i></a>&emsp;|&emsp;<a href="#" data-toggle="modal" data-target="#modal-sm<?= $val->tac_id?>"><i class="fa fa-trash text-danger" title="Delete"></i></a></td>

                  </tr>

                  <!-- Edit Staff -->
          <div class="modal fade" id="modaledit-lg<?= $val->tac_id?>">
        <div class="modal-dialog modaledit-lg">
          <div class="modal-content">
            <div class="modal-header">Edit Terms and Conditions</h4>
              <div id="msg"></div>
            ...
            <div class="modal-body">
              <!-- form start -->
              <form action="" class="terms_and_conditions_edit" method="post">
                <div class="card-body">
                  <input type="hidden" name="tacid" value="<?= $val->tac_id ?>">
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                    <label for="sname">title</label>
                    <input type="text" class="form-control" name="title" placeholder="Name" required="" value="<?= $val->tac_title ?>">
                            ...
                            <div class="col-md-12">
                              <div class="form-group">
                                ...
                                <div class="custom-file mb-3">
                                    ...
                                    <input type="file" class="custom-file-input" id="customFile" name="filename" value="<?= $val->tac_image ?>">
                                    <?php $v =explode('/',$val->tac_image); ?>
                  ...
                  <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <textarea class="form-control" name="desc"  rows="10"><?= $val->tac_desc ?></textarea>
                      </div>
                   </div>    
                   </div>    
      ...
      <!-- View Staff -->
          <div class="modal fade" id="modalview-lg<?= $val->tac_id?>">
        <div class="modal-dialog modalview-lg">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Terms and Conditions Detail</h4>
              <div id="msg"></div>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
      ...
      <!-- Delete Staff -->
      <div class="modal fade" id="modal-sm<?= $val->tac_id?>">
        <div class="modal-dialog modal-sm">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Delete Terms and Conditions</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <form action="<?php echo base_url();?>admin/delete-terms-and-conditions" method="post"> 
            <div class="modal-body">
              <input type="hidden" name="tacid" value="<?= $val->tac_id?>">
...
<script type="text/javascript">
  $(function() {
    ...
    $('.terms_and_conditions_edit').on('submit' , function (e) {
    e.preventDefault();
...
let data = new FormData($(this).get(0));
    ...
    ajax(url+"admin/update-terms-and-conditions", data).then(function(result) {
      if(result.result){
