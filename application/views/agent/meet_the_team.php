      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="card">
            ...
            <div class="card-body">
                  <!-- form start -->
                  <form  id="meet_the_team" method="post">
                    <div class="card-body">
                        ...
                        <div class="col-md-12">
                          <div class="form-group">
                            ...
                            <div class="custom-file mb-3">
                              <input type="hidden" class="custom-file-input" id="image_page" name="image_page" value="meet-the-team">
...
let data = new FormData($(this).get(0))
    ...
    $('#meet_the_team').on('submit' , function (e) {
    e.preventDefault();
