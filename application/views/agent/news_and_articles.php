        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href="<?= base_url()?>admin/news-and-articles">News and Articles</a></li>
              <li class="breadcrumb-item active"><a href="<?= base_url('admin/news-and-articles-view')?>">View</a></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="card">
            ...
            <div class="card-body">
                  <!-- form start -->
                  <form  id="news_and_articles" method="post">
                    <div class="card-body">
                        ...
                        <div class="col-md-12">
                          <div class="form-group">
                            ...
                            <div class="custom-file mb-3">
                              <input type="hidden" class="custom-file-input" id="image_page" name="image_page" value="news-and-articles">
...
let data = new FormData($(this).get(0))
    ...
    $('#news_and_articles').on('submit' , function (e) {
    e.preventDefault();
