...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="content">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><center>
                      ...
                      <?php if(!empty($val->g_image)): ?>
                      <img src="<?= base_url().$val->g_image ?>" width=150 height=150 >
                     <?php else: ?>
                       <img src="https://via.placeholder.com/150" alt="works-image" style="height:150px;width:150px;">
                     <?php endif; ?>
                    </center></td>
                    <td class="text-justify"><?= $val->g_desc ?></td>
                    ...
                    <td><a href="#" data-toggle="modal" data-target="#modalview-lg<?= $val->g_id?>"><i class="fa fa-eye text-info" title="View"></i></a>&emsp;|&emsp;<a href="#" data-toggle="modal" data-target="#modaledit-lg<?= $val->g_id?>"><i class="fa fa-edit text-success" title="Edit"></i></a>&emsp;|&emsp;<a href="#" data-toggle="modal" data-target="#modal-sm<?= $val->g_id?>"><i class="fa fa-trash text-danger" title="Delete"></i></a></td>

                  </tr>

                  <!-- Edit Staff -->
          <div class="modal fade" id="modaledit-lg<?= $val->g_id?>">
        <div class="modal-dialog modaledit-lg">
          <div class="modal-content">
            <div class="modal-header">Edit Goa</h4>
              <div id="msg"></div>
            ...
            <div class="modal-body">
              <!-- form start -->
              <form action="" class="goa_edit" method="post">
                <div class="card-body">
                  <input type="hidden" name="gid" value="<?= $val->g_id ?>">
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                    <label for="sname">title</label>
                    <input type="text" class="form-control" name="title" placeholder="Name" required="" value="<?= $val->g_title ?>">
                            ...
                            <div class="col-md-12">
                              <div class="form-group">
                                ...
                                <div class="custom-file mb-3">
                                    ...
                                    <input type="file" class="custom-file-input" id="customFile" name="filename" value="<?= $val->g_image ?>">
                                    <?php $v =explode('/',$val->g_image); ?>
                  ...
                  <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <textarea class="form-control" name="desc"  rows="10"><?= $val->g_desc ?></textarea>
                      </div>
                   </div>    
                   </div>    
      ...
      <!-- View Staff -->
          <div class="modal fade" id="modalview-lg<?= $val->g_id?>">
        <div class="modal-dialog modalview-lg">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Goa Detail</h4>
              <div id="msg"></div>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
      ...
      <!-- Delete Staff -->
      <div class="modal fade" id="modal-sm<?= $val->g_id?>">
        <div class="modal-dialog modal-sm">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Delete Goa</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <form action="<?php echo base_url();?>admin/delete-goa" method="post"> 
            <div class="modal-body">
              <input type="hidden" name="gid" value="<?= $val->g_id?>">
      ...
      <!-- /.modal -->
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Add Goa</h4>
              <div id="msg"></div>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
...
let data = new FormData($(this).get(0));
    ...
    ajax(url+"admin/update-goa", data).then(function(result) {
      if(result.result){
