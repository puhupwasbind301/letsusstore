      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="card">
            ...
            <div class="card-body">
                  <!-- form start -->
                  <form  id="pune_ranjangaon" method="post">
                    <div class="card-body">
...
<script type="text/javascript">
  $(function() {
    $('#pune_ranjangaon').on('submit' , function (e) {
    e.preventDefault();
...
let data = new FormData($(this).get(0))
    ajax(url+"admin/insert-pune-ranjangaon", data).then(function(result) {
