<!DOCTYPE html>
<html>
<?php $title = "Storage Calculator View";
  $nav_page = 6;
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Storage Calculator View</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?= base_url() ?>admin">Home</a></li>
              <li class="breadcrumb-item active"><a href="<?= base_url() ?>admin/storage-calculator">Storage Calculator</a></li>
              <li class="breadcrumb-item active"><a href="<?= base_url('admin/storage-calculator-view')?>">View</a></li>
              <li class="breadcrumb-item active"><a href="<?= base_url('admin/update-category')?>">Update Category</a></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <div class="content">
            ...
            <div class="card-body">
              ...
              <table id="tbl_id" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <th>Product Image</th>
                  <th>Product Square Feet</th>
                  <th>Product Created Date</th>
                  <th>Manage</th>
                </tr>
                </thead>
                <tbody>
                  <?php foreach($storage_calculator_view as $key => $val): ?>
                  <tr>
                    <td><?= ++$key?></td>
                    <td><?= $val->sc_name ?></td>
                    <td><?= $val->scc_name ?></td>
                    <td><center>
                      ...
                      <?php if(!empty($val->sc_image)): ?>
                      <img src="<?= base_url().$val->sc_image ?>" width=150 height=150 >
                     <?php else: ?>
                       <img src="https://via.placeholder.com/150" alt="works-image" style="width:150px;height:150px;">
                     <?php endif; ?>
                    </center></td>
                    <td><?= $val->sc_name_price ?></td>
                    <td><?= $val->sc_date_created ?></td>
                    ...
                    <td><a href="#" data-toggle="modal" data-target="#modalview-lg<?= $val->sc_id?>"><i class="fa fa-eye text-info" title="View"></i></a>&emsp;|&emsp;<a href="#" data-toggle="modal" data-target="#modaledit-lg<?= $val->sc_id?>"><i class="fa fa-edit text-success" title="Edit"></i></a>&emsp;|&emsp;<a href="#" data-toggle="modal" data-target="#modal-sm<?= $val->sc_id?>"><i class="fa fa-trash text-danger" title="Delete"></i></a></td>

                  </tr>

                  <!-- Edit Staff -->
                  
          <div class="modal fade" id="modaledit-lg<?= $val->sc_id?>">
        <div class="modal-dialog modaledit-lg">
          <div class="modal-content">
            <div class="modal-header">Edit Storage Calculator</h4>
              <div id="msg"></div>
            ...
            <div class="modal-body">
              ...
              <form action="" class="storage_calculator_edit" method="post">
                <div class="card-body">
                  <input type="hidden" name="scid" value="<?= $val->sc_id ?>">
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
	                    <label for="sname">Product Name</label>
	                    <input type="text" class="form-control" name="title" placeholder="Name" required="" value="<?= $val->sc_name ?>">
                            ...
                            <div class="col-md-12">
                              <div class="form-group">
                                ...
                                <div class="custom-file mb-3">
                                    ...
                                    <input type="file" class="custom-file-input" id="customFile" name="filename" value="<?= $val->sc_image ?>">
                                    <?php $v =explode('/',$val->sc_image); ?>
                   ...
                   <div class="col-md-6">
                     <div class="form-group">
                       <label for="sdesc">Product Square Feet</label>
                         <input type="text" class="form-control" name="squarefeet" placeholder="Name" required="" value="<?= $val->sc_name_price ?>">
                     </div>
                   </div>    
                 </div>  
      ...
      <!-- View Staff -->
          <div class="modal fade" id="modalview-lg<?= $val->sc_id?>">
        <div class="modal-dialog modalview-lg">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Storage Calculator Detail</h4>
              <div id="msg"></div>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
      ...
      <!-- Delete Staff -->
      <div class="modal fade" id="modal-sm<?= $val->sc_id?>">
        <div class="modal-dialog modal-sm">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Delete Storage Calculator</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <form action="<?php echo base_url();?>admin/delete-storage-calculator" method="post"> 
            <div class="modal-body">
              <input type="hidden" name="scid" value="<?= $val->sc_id?>">
              <!-- <input type="hidden" name="scid" value="<?= $val->sc_id ?>"> -->
      ...
      <div class="modal fade" id="modal-lg">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Add Storage Calculator</h4>
              <div id="msg"></div>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
