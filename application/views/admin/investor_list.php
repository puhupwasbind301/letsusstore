...
<div class="wrapper">
  ...
  <div class="content-wrapper">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item">
                <a href="<?= base_url() ?>supplier">Home</a>
              </li>
            </ol>
          </div>
        </div>
    ...
    <div class="content">
              ...
              <table id="tbl_id" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="btn-group">
                      <a href="#" data-toggle="modal" data-target="#modalview-lg<?= $val->user_id?>"><i class="fa fa-eye text-info" title="View"></i></a>
                      <!--&emsp;|&emsp;
                       <a href="<?= base_url('admin/investor_service_request_list/').$val->user_id ?>" ><button class="btn btn-secondary">Requests</button></a> -->
                      &emsp;|&emsp;
                      <a href="#" data-toggle="modal" data-target="#modal-sm<?= $val->user_id?>"><i class="fa fa-trash text-danger" title="Delete"></i></a>
                      </div>
                    </td>
      ...
      <!-- View Staff -->
          <div class="modal fade" id="modalview-lg<?= $val->user_id?>">
      ...
      <!-- Delete Staff -->
      <div class="modal fade" id="modal-sm<?= $val->user_id?>">
        <div class="modal-dialog modal-sm">
          <div class="modal-content">
            ...
            <form action="<?php echo base_url();?>admin/delete-supplier" method="post"> 
            <div class="modal-body">
              <input type="hidden" name="sid" value="<?= $val->user_id?>">
