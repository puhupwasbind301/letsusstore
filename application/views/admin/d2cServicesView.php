  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>D2C Services View</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?= base_url()?>admin">Home</a></li>
              <li class="breadcrumb-item active"><a href="<?= base_url()?>admin/d2c_services">D2C Services</a></li>
              <li class="breadcrumb-item active"><a href="<?= base_url('admin/d2c-services-view')?>">View</a></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
<?php $this->session->userdata('page-name'); ?>
    ...
    <div class="content">
              ...
              <table id="tbl_id" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?= $val->d_title ?></td>
                    <td><center>
                       <?php if(!empty($val->d_image)): ?>
                        <img src="<?= base_url().$val->d_image ?>" width=150 height=150>
                      <?php else: ?>
                        <img src="https://via.placeholder.com/150" alt="works-image" style="height:150px;width:150px;">
                      <?php endif; ?>
                    </center></td>
                    <td class="text-justify"><?= $val->d_desc ?></td>
                    
                    
                    <td><a href="#" data-toggle="modal" data-target="#modalview-lg<?= $val->d_id?>"><i class="fa fa-eye text-info" title="View"></i></a>&emsp;|&emsp;<a href="#" data-toggle="modal" data-target="#modaledit-lg<?= $val->d_id?>"><i class="fa fa-edit text-success" title="Edit"></i></a>&emsp;|&emsp;<a href="#" data-toggle="modal" data-target="#modal-sm"><i class="fa fa-trash text-danger" title="Delete"></i></a></td>

                  </tr>

                  <!-- Edit Staff -->
          <div class="modal fade" id="modaledit-lg<?= $val->d_id?>">
        <div class="modal-dialog modaledit-lg">
          <div class="modal-content">
            <div class="modal-header">Edit D2C Services</h4>
              <div id="msg"></div>
            ...
            <div class="modal-body">
              <!-- form start -->
              <form action="" class="d2c_services_edit" method="post">
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <input type="text" class="form-control" name="title" placeholder="Name" required="" value="<?= $val->d_title ?>">
                        ...
                        <div class="col-md-12">
                          <div class="form-group">
                            ...
                            <div class="custom-file mb-3">
                                ...
                                <input type="file" class="custom-file-input" id="customFile" name="filename" value="<?= $val->d_image ?>">
                                <?php $v =explode('/',$val->d_image); ?>
              ...
              <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <textarea class="form-control" name="desc"  rows="10"><?= $val->d_desc ?></textarea>
                  </div>
               </div>    
               </div>    
      ...
      <!-- View Staff -->
          <div class="modal fade" id="modalview-lg<?= $val->d_id?>">
        <div class="modal-dialog modalview-lg">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">D2C Services Detail</h4>
              <div id="msg"></div>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
      ...
      <div class="modal fade" id="modal-sm">
        <div class="modal-dialog modal-sm">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Delete D2C Services</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <form action="<?php echo base_url();?>admin/delete-page/d2c_services" method="post"> 
            <div class="modal-body">
              <input type="hidden" name="sid" value="<?= $val->d_id?>">
      ...
      <!-- /.modal -->
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Add D2C Services</h4>
              <div id="msg"></div>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
...
<script type="text/javascript">
  $(function() {
    ...
    $('.d2c_services_edit').on('submit' , function (e) {
    e.preventDefault();
...
let data = new FormData($(this).get(0));
    ...
    ajax(url+"admin/update-page/d2c_services", data).then(function(result) {
      if(result.result){
