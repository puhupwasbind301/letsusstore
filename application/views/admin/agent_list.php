        ...
        <div class="row">
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <!--         &emsp;|&emsp;
                      <a href="<?= base_url('admin/agent_service_request_list/').$val->user_id ?>" ><button class="btn btn-secondary">Requests</button></a> -->
                      &emsp;|&emsp;
        ...
        <div class="modal-dialog modalview-lg">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Agent Detail</h4>
              <div id="msg"></div>
