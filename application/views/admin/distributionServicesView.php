<!DOCTYPE html>
<html>
<?php $title = "Distribution Services View";
  $nav_page = 104;
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Distribution Services View</h1>
          </div>
          <div class="col-sm-6">
    ...
    <div class="content">
      <div class="container-fluid">
        ...
        <div class="modal-dialog modaledit-lg">
          <div class="modal-content">
            <div class="modal-header">Edit Distribution Services</h4>
              <div id="msg"></div>
            ...
            <div class="modal-body">
              <!-- form start -->
              <form action="" class="distribution_services_edit" method="post">
                <div class="card-body">
        ...
        <div class="modal-dialog modalview-lg">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Distribution Services Detail</h4>
              <div id="msg"></div>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            ...
            <div class="modal-body">
              ...
              <div class="row p-2">
               ...
               <div class="row p-2">
                <div class="col-md-3">
                  <b>Distribution Services Image</b>
                </div>
                <div class="col-md-9">
                  <p>
                     <img src="<?= base_url().$val->d_image ?>" width=150 height=150>
      ...
      <div class="modal fade" id="modal-sm">
        <div class="modal-dialog modal-sm">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Delete Distribution Services</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <form action="<?php echo base_url();?>admin/delete-page/distribution_services" method="post"> 
            <div class="modal-body">
              <input type="hidden" name="sid" value="<?= $val->d_id?>">
      ...
      <!-- /.modal -->
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Add Distribution Services</h4>
              <div id="msg"></div>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
...
<script type="text/javascript">
  $(function() {
    ...
    $('.distribution_services_edit').on('submit' , function (e) {
    e.preventDefault();
...
let data = new FormData($(this).get(0));
    ...
    ajax(url+"admin/update-page/distribution_services", data).then(function(result) {
      if(result.result){
