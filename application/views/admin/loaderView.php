        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href="<?= base_url()?>admin/loaders">Loaders</a></li>
              <li class="breadcrumb-item active"><a href="<?= base_url('admin/loaders-view')?>">View</a></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
<?php $this->session->userdata('page-name'); ?>
    ...
    <div class="content">
              ...
              <table id="tbl_id" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?= $val->l_title ?></td>
                    <td><center>
                       <?php if(!empty($val->l_image)): ?>
                        <img src="<?= base_url().$val->l_image ?>" width=150 height=150>
                      <?php else: ?>
                        <img src="https://via.placeholder.com/150" alt="works-image" style="height:150px;width:150px;">
                      <?php endif; ?>
                    </center></td>
                    <td class="text-justify"><?= $val->l_desc ?></td>
                    
                    
                    <td><a href="#" data-toggle="modal" data-target="#modalview-lg<?= $val->l_id?>"><i class="fa fa-eye text-info" title="View"></i></a>&emsp;|&emsp;<a href="#" data-toggle="modal" data-target="#modaledit-lg<?= $val->l_id?>"><i class="fa fa-edit text-success" title="Edit"></i></a>&emsp;|&emsp;<a href="#" data-toggle="modal" data-target="#modal-sm"><i class="fa fa-trash text-danger" title="Delete"></i></a></td>

                  </tr>

                  <!-- Edit Staff -->
          <div class="modal fade" id="modaledit-lg<?= $val->l_id?>">
        <div class="modal-dialog modaledit-lg">
          <div class="modal-content">
            <div class="modal-header">Edit Loaders</h4>
              <div id="msg"></div>
            ...
            <div class="modal-body">
              <!-- form start -->
              <form action="" class="loaders_edit" method="post">
                <div class="card-body">
                  <input type="hidden" name="sid" value="<?= $val->l_id ?>">
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                    <label for="sname">title</label>
                    <input type="text" class="form-control" name="title" placeholder="Name" required="" value="<?= $val->l_title ?>">
                        ...
                        <div class="col-md-12">
                          <div class="form-group">
                            ...
                            <div class="custom-file mb-3">
                                ...
                                <input type="file" class="custom-file-input" id="customFile" name="filename" value="<?= $val->l_image ?>">
                                <?php $v =explode('/',$val->l_image); ?>
              ...
              <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <textarea class="form-control" name="desc"  rows="10"><?= $val->l_desc ?></textarea>
                  </div>
               </div>    
               </div>    
      ...
      <!-- View Staff -->
          <div class="modal fade" id="modalview-lg<?= $val->l_id?>">
        <div class="modal-dialog modalview-lg">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Loaders Detail</h4>
              <div id="msg"></div>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
      ...
      <div class="modal fade" id="modal-sm">
        <div class="modal-dialog modal-sm">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Delete Loaders</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <form action="<?php echo base_url();?>admin/delete-page/loaders" method="post"> 
            <div class="modal-body">
              <input type="hidden" name="sid" value="<?= $val->l_id?>">
      ...
      <!-- /.modal -->
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Add Loaders</h4>
              <div id="msg"></div>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
...
<script type="text/javascript">
  $(function() {
    ...
    $('.loaders_edit').on('submit' , function (e) {
    e.preventDefault();
...
let data = new FormData($(this).get(0));
    ...
    ajax(url+"admin/update-page/loaders", data).then(function(result) {
      if(result.result){
