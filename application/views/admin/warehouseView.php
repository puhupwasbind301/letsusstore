        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href="<?= base_url()?>admin/warehouse">Warehouse</a></li>
              <li class="breadcrumb-item active"><a href="<?= base_url('admin/warehouse-view')?>">View</a></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
        ...
        <div class="modal-dialog modaledit-lg">
          <div class="modal-content">
            <div class="modal-header">Edit Warehouse</h4>
              <div id="msg"></div>
            ...
            <div class="modal-body">
              <!-- form start -->
              <form action="" class="warehouse_edit" method="post">
                <div class="card-body">
      ...
      <div class="modal fade" id="modal-sm">
        <div class="modal-dialog modal-sm">
          <div class="modal-content">
            ...
            <form action="<?php echo base_url();?>admin/delete-page/warehouse" method="post"> 
            <div class="modal-body">
              <input type="hidden" name="sid" value="<?= $val->w_id?>">
...
<script type="text/javascript">
  $(function() {
    ...
    $('.warehouse_edit').on('submit' , function (e) {
    e.preventDefault();
...
let data = new FormData($(this).get(0));
    ...
    ajax(url+"admin/update-page/warehouse", data).then(function(result) {
      if(result.result){
