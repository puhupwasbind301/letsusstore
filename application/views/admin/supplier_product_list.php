              ...
              <table id="tbl_id" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a href="#" data-toggle="modal" data-target="#modalview-lg<?= $val->sp_id?>"><i class="fa fa-eye text-info" title="View"></i></a>
                      <!-- &emsp;|&emsp;<a href="#" data-toggle="modal" data-target="#modaledit-lg<?= $val->sp_id?>"><i class="fa fa-edit text-success" title="Edit"></i></a> -->
                      &emsp;|&emsp;<a href="#" data-toggle="modal" data-target="#modal-sm<?= $val->sp_id?>"><i class="fa fa-trash text-danger" title="Delete"></i></a></td>
      ...
      <div class="modal fade" id="modal-sm<?= $val->sp_id?>">
        <div class="modal-dialog modal-sm">
          <div class="modal-content">
            ...
            <form action="<?php echo base_url();?>admin/delete-supplier-product" method="post"> 
            <div class="modal-body">
              <input type="hidden" name="spid" value="<?= $val->sp_id?>">
