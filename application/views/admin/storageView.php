        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href="<?= base_url()?>admin/storage">Storage</a></li>
              <li class="breadcrumb-item active"><a href="<?= base_url('admin/storage-view')?>">View</a></li>
            </ol>
          </div>
      ...
      <div class="container-fluid">
        ...
        <div class="modal-dialog modaledit-lg">
          <div class="modal-content">
            <div class="modal-header">Edit Storage</h4>
              <div id="msg"></div>
            ...
            <div class="modal-body">
              <!-- form start -->
              <form action="" class="storage_edit" method="post">
                <div class="card-body">
        ...
        <div class="modal-dialog modalview-lg">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Storage Detail</h4>
              <div id="msg"></div>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
      ...
      <div class="modal fade" id="modal-sm">
        <div class="modal-dialog modal-sm">
          <div class="modal-content">
            ...
            <form action="<?php echo base_url();?>admin/delete-page/storage" method="post"> 
            <div class="modal-body">
              <input type="hidden" name="sid" value="<?= $val->s_id?>">
...
<script type="text/javascript">
  $(function() {
    ...
    $('.storage_edit').on('submit' , function (e) {
    e.preventDefault();
...
let data = new FormData($(this).get(0));
    console.log(data);
    ajax(url+"admin/update-page/storage", data).then(function(result) {
      if(result.result){
