        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href="<?= base_url()?>admin/hardware">Hardware</a></li>
              <li class="breadcrumb-item active"><a href="<?= base_url('admin/hardware-view')?>">View</a></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
        ...
        <div class="modal-dialog modaledit-lg">
          <div class="modal-content">
            <div class="modal-header">Edit Hardware</h4>
              <div id="msg"></div>
            ...
            <div class="modal-body">
              <!-- form start -->
              <form action="" class="hardware_edit" method="post">
                <div class="card-body">
                  <input type="hidden" name="sid" value="<?= $val->h_id ?>">
                  <div class="row">
                    <div class="col-md-12">
        ...
        <div class="modal-dialog modalview-lg">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Hardware Detail</h4>
              <div id="msg"></div>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
      ...
      <div class="modal fade" id="modal-sm">
        <div class="modal-dialog modal-sm">
          <div class="modal-content">
            ...
            <form action="<?php echo base_url();?>admin/delete-page/hardware" method="post"> 
            <div class="modal-body">
              <input type="hidden" name="sid" value="<?= $val->h_id?>">
...
<script type="text/javascript">
  $(function() {
    ...
    $('.hardware_edit').on('submit' , function (e) {
    e.preventDefault();
...
let data = new FormData($(this).get(0));
    ...
    ajax(url+"admin/update-page/hardware", data).then(function(result) {
      if(result.result){
