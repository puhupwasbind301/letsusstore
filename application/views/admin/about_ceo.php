             ...
             <div class="modal-content">
               ...
               <div class="modal-body">
                 ...
                 <form  class="add_meta_data" method="post">
                   <div class="card-body">
                     <div id="messageForm"></div>
                    <input type="hidden" class="custom-file-input" id="image_page-meta" name="image_page-meta" value="about_ceo">
                                    <div class="row">
                                                        <div class="col-md-6">
                                                          <div class="form-group">
...
<script type="text/javascript">
  $(function() {
    ...
    $('#about_ceo').on('submit' , function (e) {
    e.preventDefault();
...
let url = $('meta[name=url]').attr("content");
let data = new FormData($(this).get(0))
    ajax(url+"admin/insert-about-ceo", data).then(function(result) {
