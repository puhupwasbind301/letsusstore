  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Add New Storage Calculator</h1>
          </div>
          <div class="col-sm-6">
        ...
        <div class="row">
          ...
          <div class="card">
            ...
            <div class="card-header">
              <button type="button" class="btn btn-info float-right" data-toggle="modal" data-target="#modal-lg">Add Categories</button>
            </div>
            ...
            <div class="card-body">
                  ...
                  <form  id="storage_calculator" method="post">
                    <div class="card-body">
                      ...
                      <div class="row">
                          ...
                          <select name="storage_calculator_categories" id="storage_calculator_categories" class="form-control" >
                              <option value="" style="display: none;"></option>
                                <?php foreach ($storage_calculator_categories as $key => $value): ?>
                                  <option value="<?= $value->scc_id ?>"><?= $value->scc_name ?></option>
                                <?php endforeach ?>
                            </select>
                          </div>
                        </div>  
                       ...
                       <div class="row">
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                             <label for="name">Product Square Feet</label>
                             <input type="number" step="any" class="form-control" id="title" name="squarefeet" placeholder="Product Square Feet" required="" >
                           </div>
                         </div>
     ...
     <div class="modal-dialog modal-lg">
       <div class="modal-content">
         ...
         <div class="modal-body">
           <!-- form start -->
           <form  id="add_storage_category" method="post">
             <div class="card-body">
               <div id="messageForm"></div>
               <div class="row">
                 <div class="col-md-12">
                   <div class="form-group">
                     <label for="name">Storage Category Name</label>
                     <input type="text" class="form-control" id="storage_cat_name" name="storage_cat_name" placeholder="Storage Category Name" required="" >
                   </div>
                 </div>
               </div>
...
<script type="text/javascript">
  $(function() {
    $('#add_storage_category').on('submit' , function (e) {
    e.preventDefault();
    // alert('hiii');
    // return false;
...
let data = new FormData($(this).get(0))
    ajax(url+"admin/insert-storage-category", data).then(function(result) {
        if(result.status){
        ...
        //   $(#add_storage_category #messageForm).html('<strong>Success!</strong> Successfully Added Category');
        //   return false;
        // }
        // else{
...
<script type="text/javascript">
  $(function() {
    ...
    $('#storage_calculator').on('submit' , function (e) {
    e.preventDefault();
...
let data = new FormData($(this).get(0));
    ...
    ajax(url+"admin/insert-storage-calculator", data).then(function(result) {
        if(result.result){
            window.location.reload()
          }
          else{
