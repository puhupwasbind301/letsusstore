      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="card">
            ...
            <div class="card-body">
                  <!-- form start -->
                  <form  id="d2c_services" method="post">
                    <div class="card-body">
                ...
                <div class="row">
                 ...
                 <div class="col-md-12">
                   <div class="form-group">
                     <label for="name">Image</label>
                     <div class="custom-file mb-3">
                         <input type="hidden" class="custom-file-input" id="image_page" name="image_page" value="d2c_services">
                         <input type="file" class="custom-file-input" id="customFile" name="filename">
                         <label class="custom-file-label" for="customFile" style="overflow:hidden;">Choose Image</label>
                     </div>
                   </div>
             ...
             <div class="modal-content">
               ...
               <div class="modal-body">
                 ...
                 <form  class="add_meta_data" method="post">
                   <div class="card-body">
                     <div id="messageForm"></div>
                    <input type="hidden" class="custom-file-input" id="image_page-meta" name="image_page-meta" value="d2c_services">
                                    <div class="row">
                                                        <div class="col-md-6">
                                                          <div class="form-group">
...
let data = new FormData($(this).get(0))
   ...
   $('#d2c_services').on('submit' , function (e) {
    e.preventDefault();
...
let url = $('meta[name=url]').attr("content");
let data = new FormData($(this).get(0))
    ajax(url+"admin/insert-page/d2c_services", data).then(function(result) {
