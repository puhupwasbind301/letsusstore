      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="card">
            ...
            <div class="card-body">
                  <!-- form start -->
                  <form  id="main_section" method="post">
                    <div class="card-body">
                      ...
                      <div class="row">
                        <div class="col-md-12">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="title_heading" name="title_heading" placeholder="Title" required="" >
                       ...
                       <div class="row">
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="link_name" name="link_name" placeholder="Link Name" required="" >
       ...
       <div class="modal-content">
         ...
         <div class="modal-body">
           ...
           <form  class="add_meta_data" method="post">
             <div class="card-body">
               <div id="messageForm"></div>
              <input type="hidden" class="custom-file-input" id="image_page-meta" name="image_page-meta" value="home">
                              <div class="row">
                                                  <div class="col-md-6">
                                                    <div class="form-group">
...
<script type="text/javascript">
  $(function() {
    ...
    $('#main_section').on('submit' , function (e) {
    e.preventDefault();
    for (instance in CKEDITOR.instances) {
...
let data = new FormData($(this).get(0))
    ...
    ajax(url+"admin/insert-home", data).then(function(result) {
      if(result.result){
        window.location.reload()
      }
      else{
