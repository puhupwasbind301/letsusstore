...
class Customer extends CI_Controller {
	public function __construct(){
		...
		// }	
		// echo '<pre>';
		// 	print_r($this->session->userdata('authVendorLogin'));
		// 	exit();
		if($this->session->userdata('authVendorLogin')['user_type'] != 'Customer') {
	...
	public function customer_service_request() {
		$services = $this->Customer_model->fetchTable('service','s_id');
		$this->load->view('customer/customer_service_request',compact('services'));
	}

	public function customer_service_request_list() {
		$requests = $this->Customer_model->getTableById('requests',
								[
								 'r_user_id'=>$this->session->userdata('authVendorLogin')['user_id']
								]
							)->result();

		$this->load->view('customer/customer_service_request_list',compact('requests'));
	}

	public function requestInvoice() {
	
		$request_invoice = $this->Customer_model->getTableById('request_invoice',['ri_user_id'=>$this->session->userdata('authVendorLogin')['user_id']])->result();
		$this->load->view('customer/request_invoice',compact('request_invoice'));
	}

	public function invoice($ri_id,$ri_no,$pdf) {
		

		$request_detail = $this->Customer_model->getTableById('requests',['r_id'=>$ri_no])->row();
	
		$user_detail = $this->Customer_model->getTableById('users',['user_id'=>$this->session->userdata('authVendorLogin')['user_id']])->row();
		$request_invoice = $this->Customer_model->getTableById('request_invoice',['ri_id'=>$ri_id])->row();
		// $invoiceData = $this->Customer_model->getInvoiceDetail($user_detail[0],$request_invoice[0]);
		// echo $invoiceData;
		// exit();
		// $this->load->view('customer/print-details',compact('request_invoice','user_detail','invoiceData'));
		// $this->pdf->loadHTML($invoiceData);
		// $this->pdf->render();
		// $this->pdf->stream($this->session->userdata('authVendorLogin')['user_id'].".pdf", array("Attachment"=>0));
		
		$this->load->view('customer/print_details',compact('request_detail','request_invoice','user_detail','pdf'));
		...
		// $dompdf->stream($invoiceData,['Attachment'=>false]);
	}
	...
	public function mainSection() {
		...
		$this->load->view('admin/main_section',compact('no_of_main_section_added'));
	}
	...
	public function companyProfile() {
		...
		$this->load->view('admin/company_profile',compact('no_of_banned_added'));
		
	}
	public function companyProfileView() {

		$data = $this->Admin_model->fetchTable('company_profile','cp_id');
		$this->load->view('admin/company_profile_view',compact('data'));
		
		
	}	
	public function aboutCEO() {
		$no_of_banned_added = $this->Admin_model->fetchBanner('about-ceo');
		$this->load->view('admin/about_ceo',compact('no_of_banned_added'));
		
	}

	public function aboutCEOView() {
			$data = $this->Admin_model->fetchTable('about_ceo','ac_id');
			$this->load->view('admin/about_ceo_view',compact('data'));
	}
	
	public function corpoateResponsibilityInitiative() {
		$no_of_banned_added = $this->Admin_model->fetchBanner('cri');
		$this->load->view('admin/corpoate_responsibility_initiative',compact('no_of_banned_added'));
	}

	public function corpoateResponsibilityInitiativeView() {
		$data = $this->Admin_model->fetchTable('corpoate_responsibility_initiative','cri_id');
		$this->load->view('admin/corpoate_responsibility_initiative_view',compact('data'));
		
	}


	public function covidPrecautions() {
		$no_of_banned_added = $this->Admin_model->fetchBanner('covid-precautions');
		$this->load->view('admin/covid_precautions',compact('no_of_banned_added'));
		
	}

	public function covidPrecautionsView() {
		$data = $this->Admin_model->fetchTable('covid_precautions','cp_id');
		$this->load->view('admin/covid_precautions_view',compact('data'));
	...
	public function privateRooms() {
		...
		$this->load->view('admin/private_rooms',compact('no_of_banned_added'));
	...
	public function boxStorage() {
		...
		$this->load->view('admin/box_storage',compact('no_of_banned_added'));
	...
	public function utilityLocker() {
		...
		$this->load->view('admin/utility_locker',compact('no_of_banned_added'));
	...
	public function bikeStorage() {
		...
		$this->load->view('admin/bike_storage',compact('no_of_banned_added'));
	...
	public function benefits() {
		...
		$this->load->view('admin/benefits',compact('no_of_banned_added'));
	...
	// Locations
	public function delhiMundka() {
		$this->load->view('admin/delhi_mundka');
	}
	public function delhiMundkaView(){
		$data = $this->Admin_model->fetchTable('delhi_mundka','dm_id');
		$this->load->view('admin/delhi_mundka_view',compact('data'));
	}

	public function gurgaonHondachowk() {
		$this->load->view('admin/gurgaon_hondachowk');
	}
	public function gurgaonHondachowkView(){
		$data = $this->Admin_model->fetchTable('gurgaon_hondachowk','ghc_id');
		$this->load->view('admin/gurgaon_hondachowk_view',compact('data'));
	}

	public function puneRanjangaon() {
		$this->load->view('admin/pune_ranjangaon');
	}
	public function puneRanjangaonView(){
		$data = $this->Admin_model->fetchTable('pune_ranjangaon','prg_id');
		$this->load->view('admin/pune_ranjangaon_view',compact('data'));
	}

	public function chennai() {
		$this->load->view('admin/chennai');
	}
	public function chennaiView(){
		$data = $this->Admin_model->fetchTable('chennai','c_id');
		$this->load->view('admin/chennai_view',compact('data'));
	}

	public function hyderabad() {
		$this->load->view('admin/hyderabad');
	}
	public function hyderabadView(){
		$data = $this->Admin_model->fetchTable('hyderabad','h_id');
		$this->load->view('admin/hyderabad_view',compact('data'));
	}

	public function kolkatta() {
		$this->load->view('admin/kolkatta');
	}
	public function kolkattaView(){
		$data = $this->Admin_model->fetchTable('kolkatta','k_id');
		$this->load->view('admin/kolkatta_view',compact('data'));
	}

	public function mumbai() {
		$this->load->view('admin/mumbai');
	}
	public function mumbaiView(){
		$data = $this->Admin_model->fetchTable('mumbai','m_id');
		$this->load->view('admin/mumbai_view',compact('data'));
	}

	public function goa() {
		$this->load->view('admin/goa');
	}
	public function goaView(){
		$data = $this->Admin_model->fetchTable('goa','g_id');
		$this->load->view('admin/goa_view',compact('data'));
	}
	...
	public function termsAndConditions() {
		...
		$this->load->view('admin/terms_and_conditions',compact('no_of_banned_added'));
	...
	public function privacyPolicy() {
		...
		$this->load->view('admin/privacy_policy',compact('no_of_banned_added'));
	...
	public function contactUs() {
		...
		$this->load->view('admin/contact_us',compact('no_of_banned_added'));
	...
	//     $config['upload_path']          = './uploads/customer_panel'.$path_folder; //file save path
	...
	public function upload_image($table='',$path_folder='',$file_input_name='',$table_id_name='', $table_image_name='', $insert_id=''){
			...
			// mkdir('./uploads/customer_panel'.$path_folder, 0777, true);
			// var_dump(!file_exists('./uploads/customer_panel'.$path_folder));
			// var_dump(!is_dir('./uploads/customer_panel'.$path_folder));
			// exit();	
			// writable
			// $s= var_dump(mkdir('./uploads/customer_panel'.$path_folder, 0777));
			// echo $s;
			// exit();

			if(!file_exists('./uploads/customer_panel'.$path_folder)) {
				if(!is_dir('./uploads/customer_panel'.$path_folder)) {
				// mkdir('./uploads/customer_panel'.$path_folder, 0777, true);
				
				try{
					if(!mkdir('./uploads/customer_panel'.$path_folder, 0777, true)){
			...
			$output = array();
	        $config['upload_path']   = './uploads/customer_panel'.$path_folder; 
	...
	public function insertCompanyProfile(){
		...
		if($this->form_validation->run() == false){
			...
			$cp_insert_id = $this->Admin_model->insertCompanyProfile();
			
			$dd = $this->upload_image('company_profile','company_profile','filename','cp_id', 	'cp_image', $cp_insert_id);
	...
	public function updateCompanyProfile(){
		$upd = $this->Admin_model->insertCompanyProfile();
		// upload_image($table='',$path_folder='',$file_input_name='',$table_id_name='', $table_image_name='', $insert_id='')
		$dd = $this->upload_image('company_profile','company_profile','filename','cp_id', 	'cp_image', $upd);
