...
class Supplier extends CI_Controller {
	public function __construct(){
		...
		// }
			...
			// exit();
		if($this->session->userdata('authVendorLogin')['user_type'] != 'Supplier') {
	...
	public function supplierAddProduct() {
		$this->load->view('supplier/supplier_new_product');
	}

	public function supplierProductList() {
		$data = $this->Supplier_model->getTableById('supplier_products',['sp_user_id'=>$this->session->userdata('authVendorLogin')['user_id']]);
		$this->load->view('supplier/supplier_product_list',compact('data'));
	}
	...
	public function insertSupplierProduct() {
		...
		if($this->form_validation->run() == false){
			...
			$insert_id = $this->Supplier_model->insertSupplierProduct();
	...
	public function updateSupplierProduct(){
		$updated_id = $this->Supplier_model->insertSupplierProduct();
	...
	public function insertCompanyProfile(){
		...
		if($this->form_validation->run() == false){
			...
			$cp_insert_id = $this->Supplier_model->insertCompanyProfile();
