...
(119, 'Land', '', '<p>Test Descriptions</p>\r\n', 'test land title', 'keyword 1, keywords2', '<p>test meta description</p>\r\n'),
(120, 'sample', '', '<p>as;ljasld;j ld;jas ;ldj ;dj;as ds;la jd;lsd j;las jdkasdklajdkljdklasj dkl jdklasd jklad klasd jkld jklad jkld jkld jkld jklasd jkldj klasdj kld jklj klj skldfj sdkl fjskdlfj l</p>\r\n', 'sample sample', 'sample sample sample sample sample', '<p>as;ljasld;j ld;jas ;ldj ;dj;as ds;la jd;lsd j;las jdkasdklajdkljdklasj dkl jdklasd jklad klasd jkld jklad jkld jkld jkld jklasd jkldj klasdj kld jklj klj skldfj sdkl fjskdlfj l</p>\r\n');
...
(41, NULL, 'Material Handling', 'We require 1 forklift', 'Naveen', 'Delhi', 'Delhi', 'Delhi', '110041', 'yadavnaveen10@gmail.com', '8130959866', 'pending', '2022-01-14 10:24:36'),
(42, NULL, 'Technology', 'qwertyu', 'Jedia', '51 c2 janak puri', 'New Delhi', 'Delhi', '110077', 'mayank@xcrino.com', '8802878718', 'pending', '2022-01-14 10:34:13'),
(43, NULL, 'Technology', 'this', 'Puhupwas', 'address', 'city', 'state', '112222', 'puhupwasnew@gmail.com', '232132122', 'pending', '2022-01-14 10:39:33'),
(44, NULL, 'Distribution Service', 'Req Decription', 'Puhupwas', 'Address', 'City', 'State', '123232', 'puhupwasnew@gmail.com', '242424', 'pending', '2022-01-15 14:02:17'),
(45, NULL, 'Land', 'description', 'slfjsdl', 'slfjlfj', 'sfjl', 'sjfl', '234422', 'puhupwasnewcustomer@gmail.com', '2423417', 'pending', '2022-01-15 14:28:50'),
(46, NULL, 'Warehouse', 'Warehousedes', 'Puhupwas', 'address', 'city', 'state', '234423', 'puhupwasnewcustomer@gmail.com', '23423423', 'pending', '2022-01-15 14:33:37');
...
(61, 0, 43, 'Technology', 22, '12', '2212', '2022-01-15 13:40:26');
...
(117, 'Secondary Services', 'uploads/secondary_service/file_61dd1c017a8fa1641880577.jpg', '<p>Secondary Services: Our secondary services have Plant to distributor point. Distributor to further stockiest &amp; retailers. Warehouse to various remote location &amp; on site delivery. Intra circle &amp; state transportation.</p>\r\n', 'meta title', 'meta keyword', '<p>meta description</p>\r\n');
...
--
ALTER TABLE `bike_storage`
  MODIFY `bks_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=57;
...
--
ALTER TABLE `bts`
  MODIFY `b_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=118;
...
--
ALTER TABLE `land`
  MODIFY `l_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=121;
...
--
ALTER TABLE `private_rooms`
  MODIFY `pr_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=65;

--
-- AUTO_INCREMENT for table `rcc`
--
ALTER TABLE `rcc`
  MODIFY `r_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=119;

--
-- AUTO_INCREMENT for table `requests`
--
ALTER TABLE `requests`
  MODIFY `r_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;

--
-- AUTO_INCREMENT for table `request_invoice`
--
ALTER TABLE `request_invoice`
  MODIFY `ri_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=62;
...
--
ALTER TABLE `user_contact_details`
  MODIFY `ucd_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=107;
