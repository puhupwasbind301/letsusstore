 ...
 <aside class="main-sidebar sidebar-dark-primary elevation-4" style="  background-image: linear-gradient(to right, darkgreen , #ddd);"> 
  <!-- Brand Logo -->
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
           ...
           <li class="nav-item">
            <a href="<?= base_url() ?>customer" class="nav-link <?php if($nav_page === 1) { echo 'active'; } ?>">
           ...
           <li class="nav-item has-treeview <?php if(in_array($nav_page, [2,3,4]) ) { echo 'menu-open'; } ?>">
                       <a href="<?php if(in_array($nav_page, [2,3,4]) ) { echo 'active'; } ?>" class="nav-link">
                       ...
                       <ul class="nav nav-treeview">
                         <li class="nav-item">
                           <a href="<?= base_url()?>customer/customer_service_request" class="nav-link <?php if($nav_page === 2) { echo 'active'; } ?>" class="nav-link">
                             <i class="fa fa-list nav-icon"></i>
                             <p>Service Request</p>
                           </a>
                         </li>
                         <li class="nav-item">
                           <a href="<?= base_url()?>customer/customer_service_request_list" class="nav-link <?php if($nav_page === 3) { echo 'active'; } ?>" class="nav-link">
                         ...
                         <li class="nav-item">
                           <a href="<?= base_url()?>customer/request_invoice" class="nav-link <?php if($nav_page === 4) { echo 'active'; } ?>" class="nav-link">
                             <i class="far fa-clock nav-icon"></i>
                             <p>Request Invoice</p>
                           </a>
                         </li>
